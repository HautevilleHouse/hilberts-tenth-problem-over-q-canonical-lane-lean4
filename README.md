# Hilberts Tenth Problem over Q — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/hilberts-tenth-problem-over-q-canonical-lane-mathlib.git
cd hilberts-tenth-problem-over-q-canonical-lane-mathlib
lake exe
lake build
```
